...
/* 11 */
/*!***************************************!*\
  !*** F:/吴/uniapp项目/豆瓣/store/index.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _qqmapWxJssdkMin = _interopRequireDefault(__webpack_require__(/*! ../static/qqmap-wx-jssdk.min.js */ 13));

var _index = __webpack_require__(/*! ../apis/index.js */ 14);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(n);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function _iterableToArrayLimit(arr, i) {if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return;var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;} //引入地图API文件
_vue.default.use(_vuex.default); // getInTheaters().then((res)=>{
//	console.log(res);
//})
    ...
    getCity: function getCity(context) {
      ...
      uni.authorize({
        ...
        success: function success() {
          var qqmapsdk = new _qqmapWxJssdkMin.default({ //引入地图api
...
/* 13 */
/*!*****************************************************!*\
  !*** F:/吴/uniapp项目/豆瓣/static/qqmap-wx-jssdk.min.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 14 */
/*!**************************************!*\
  !*** F:/吴/uniapp项目/豆瓣/apis/index.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.details = exports.newMovies = exports.comingSoon = exports.getInTheaters = void 0;var baseUrl = "https://douban-api.uieee.com";

var getInTheaters = function getInTheaters(params) {return (//箭头函数默认会返回对象,跟普通函数区别
...
//跳转详情页
exports.newMovies = newMovies;var details = function details(id) {return (
    //电影详情
    uni.request({
      url: "".concat(baseUrl, "/v2/movie/subjext/").concat(id),
      data: params,
      header: {
        'content-type': 'json' }
